...
1. The metadata for all images in the AC-1M is stored in the AC1M.csv file for which you can email us at t.o.l.alpherts@uva.nl. This file has four columns: nb (neighbourhood), cluster, filename, url, and metadata_url.
